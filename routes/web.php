...
Route::get('/dashboard', [WalletPageController::class, 'dashboard'])
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/deposit', [WalletPageController::class, 'depositForm'])->name('wallet.deposit');
    Route::get('/transfer', [WalletPageController::class, 'transferForm'])->name('wallet.transfer');
